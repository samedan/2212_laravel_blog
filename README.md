...
> > > > > > < php artisan make:migration column_name

## Laravel policy (check condition)

> php artisan make:policy PostPolicy --model=Post
> Add it to /app/Providers/AuthServiceProvider.php

## Gate (check a policy for the entire app)

> /app/Providers/AuthServiceProvider

## Create a link to the Uploaded files
